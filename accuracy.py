...
"""
import math, struct
import terms as T, numeric as NUM
...
def compare(spec_terms, kern_terms, bufsize, ratio_alarm=100.0, seed=0):
    ...
    Returns ("pass", None) or ("worse", {regime, spec_rel_err, kernel_rel_err, ratio})."""
    worst = None
    ...
    return "worse", {"regime": name, "spec_rel_err": es, "kernel_rel_err": ek, "ratio": ratio}
